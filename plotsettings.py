...
#rc('text.latex', preamble=['\\usepackage{cmbright}', '\\usepackage{amsmath}', '\\usepackage{amssymb}'])
...
vigit_color_3_dark              = '#083c4c'
vigit_color_3_light             = '#88bbcc'
vigit_color_4_dark              = '#0c5a70'
...
colors_vigit                    = [ vigit_color_1, vigit_color_2, vigit_color_3, vigit_color_4, vigit_color_5,
                                    ...
                                    vigit_color_11, vigit_color_12,
                                    vigit_grey_1, vigit_grey_2, vigit_grey_3, vigit_grey_4, vigit_grey_5,
                                    vigit_grey_6, vigit_grey_7, vigit_grey_8, vigit_grey_9
                                    ]
